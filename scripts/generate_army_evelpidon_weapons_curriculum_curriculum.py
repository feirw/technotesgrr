"""Generate ARMY_EVELPIDON_WEAPONS_CURRICULUM — link-only stub (institutional academy portal, not a per-department course page)."""
...
def main() -> None:
    lines = [
        ...
        "",
        f"export const ARMY_EVELPIDON_WEAPONS_CURRICULUM: SchoolCurriculum = {{",
        f'  title: "{esc(TITLE)}",',
