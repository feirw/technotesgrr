"""Generate PAMAK_BALKAN_STUDIES_CURRICULUM — link-only stub (course data removed; site has full program)."""
...
EXTERNAL_URL = "https://www.uom.gr/bso"
...
def main() -> None:
    lines = [
        ...
        "",
        f"export const PAMAK_BALKAN_STUDIES_CURRICULUM: SchoolCurriculum = {{",
        f'  title: "{esc(TITLE)}",',
