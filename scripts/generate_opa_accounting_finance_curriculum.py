"""Generate OPA_ACCOUNTING_FINANCE_CURRICULUM — link-only stub (course data removed; site has full program)."""
...
EXTERNAL_URL = "https://www.dept.aueb.gr/el/loxri_courses"
...
def main() -> None:
    lines = [
        ...
        "",
        f"export const OPA_ACCOUNTING_FINANCE_CURRICULUM: SchoolCurriculum = {{",
        f'  title: "{esc(TITLE)}",',
