            ...
            >
              {messages.map((m, i) => (
                ...
                >
                  ...
                  >
                    <div
                      className={`w-8 h-8 rounded-full flex items-center justify-center flex-shrink-0 ${m.role === 'user' ? 'bg-gradient-to-br from-pink-400 to-rose-400' : 'bg-white border-2 border-pink-300'}`}
                    >
                      {m.role === 'user' ? (
