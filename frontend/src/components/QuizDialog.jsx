  ...
  return (
    <AnimatePresence>
      <div className="fixed inset-0 flex items-center justify-center p-4 z-50">
            ...
            {Array.from({ length: 30 }).map((_, i) => (
              <motion.div
                ...
                style={{
                  ...
                  top: '-10%',
                  backgroundColor: ['#fda8a9', '#10b981', '#3b82f6', '#f59e0b'][
        ...
        <motion.div
          className="relative w-full max-w-3xl rounded-3xl shadow-2xl overflow-hidden bg-white"
        ...
        >
          ...
          <div className="p-8">
            ...
            {/* Question */}
            <motion.div
              className="mb-8 p-6 rounded-2xl bg-gradient-to-br from-pink-50 to-rose-50"
              ...
              {loading ? (
                ...
                question?.answers?.map((ans, idx) => {
                  ...
                  return (
                    ...
                    `}
                      initial={{ opacity: 0, x: -20 }}
                      animate={{ opacity: 1, x: 0, scale: isRevealed && isSelected ? 1.02 : 1 }}
                    ...
                    >
                      ...
                      <span
                        className={`flex-1 ${isRevealed && isCorrect ? 'text-green-800' : isRevealed && !isCorrect && isSelected ? 'text-red-800' : 'text-gray-800'}`}
                      >
                        {ans.text}
                      </span>
            ...
            <div className="flex justify-between pt-4 border-t-2 border-pink-100">
              <motion.button
                ...
                disabled={current === 0}
                className={`flex items-center gap-2 px-6 py-3 rounded-xl font-semibold ${current === 0 ? 'bg-gray-100 text-gray-400 cursor-not-allowed' : 'bg-white text-gray-700 border-2 border-pink-200 hover:border-pink-400'}`}
              ...
              <motion.button
                ...
                className={`flex items-center gap-2 px-6 py-3 rounded-xl font-bold text-white ${isLastQuestion ? 'bg-gray-400 cursor-not-allowed' : ''}`}
                style={{
