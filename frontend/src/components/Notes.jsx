...
const Palia = ({ pdfPath = '/pdfs/notes.pdf', fileName = 'panel.pdf' }) => {
  ...
  return (
    <motion.div ref={containerRef} className="bg-white rounded-3xl shadow-2xl overflow-hidden" style={{ border: `3px solid ${BRAND}` }} initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ type: 'spring', stiffness: 300 }}>
