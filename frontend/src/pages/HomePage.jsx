        ...
        <footer className="relative bg-gradient-to-br from-pink-50 via-rose-50 to-red-50 dark:from-gray-900 dark:via-purple-900/20 dark:to-gray-900 border-t border-pink-200 dark:border-gray-700 mt-20">
          <div className="container mx-auto px-6 py-16 grid grid-cols-1 md:grid-cols-3 gap-12 text-center md:text-left">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h3 className="text-2xl font-black text-gray-900 dark:text-white mb-4 bg-gradient-to-r from-pink-600 to-rose-600 bg-clip-text text-transparent">
                Σχετικά με εμάς 🎓
              </h3>
              ...
              <div className="space-y-3">
                {[
                  ...
                  <motion.a
                    ...
                    className="block text-gray-600 dark:text-gray-300 hover:text-pink-600 dark:hover:text-pink-400 font-medium transition-colors"
          ...
          <div className="border-t border-pink-200 dark:border-gray-700 py-6">
            <h3 className="text-xl font-bold text-gray-800 dark:text-gray-100 text-center mb-4">
              Όροι και Δεδομένα
            </h3>
            <div className="flex justify-center gap-8 flex-wrap">
              {[
                { href: '/privacy', label: 'Όροι χρήσης και Πολιτική Απορρήτου' },
                ...
                <motion.a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-gray-600 dark:text-gray-300 hover:text-pink-600 dark:hover:text-pink-400 font-medium transition-colors"
          ...
          <div className="bg-gradient-to-r from-pink-100/50 to-rose-100/50 dark:from-gray-800/50 dark:to-purple-900/30 backdrop-blur py-6 border-t border-pink-200 dark:border-gray-700">
