...
const ALL_SCHOOLS: School[] = [
  ...
  {
    id: '1211',
    name: 'Εφαρμοσμένης Πληροφορικής (Επιστ. Τεχν.)',
    uni: 'ΠΑΜΑΚ',
    city: 'Θεσσαλονίκη',
    points: 16915,
    ebe: '12.60',
  ...
  {
    id: '1212',
    name: 'Εφαρμοσμένης Πληροφορικής (Πληρ. Συστ.)',
    uni: 'ΠΑΜΑΚ',
    city: 'Θεσσαλονίκη',
    points: 16705,
    ebe: '12.60',
  ...
  {
    id: '1625',
    name: 'Μηχανικών Πληροφορικής & Ηλεκτρον. Συστ.',
    uni: 'ΔΙΠΑΕ',
    city: 'Θεσσαλονίκη',
    points: 14740,
    ebe: '12.60',
  ...
  {
    id: '1622',
    name: 'Μηχανικών Πληρ. Υπολ. & Τηλεπικ.',
    uni: 'ΔΙΠΑΕ',
    city: 'Σέρρες',
    points: 13450,
    ebe: '10.50',
  ...
  {
    id: '389',
    name: 'Μηχανικών Βιομηχανικής Σχεδίασης',
    uni: 'ΠΑΔΑ',
    city: 'Αιγάλεω',
    points: 12032,
    ebe: '12.39',
  ...
  {
    id: '238',
    name: 'Μηχανικών Σχεδίασης Προϊόντων',
    uni: 'ΑΙΓΑΙΟΥ',
    city: 'Σύρος',
    points: 10330,
    ebe: '10.50',
  ...
  {
    id: '344',
    name: 'Μηχανικών Πληρ/κών & Επικ. Συστημάτων',
    uni: 'ΑΙΓΑΙΟΥ',
    city: 'Σάμος',
    points: 9660,
    ebe: '8.40',
  ...
  {
    id: '176',
    name: 'Βαλκανικών, Σλαβικών & Ανατ. Σπουδών',
    uni: 'ΠΑΜΑΚ',
    city: 'Θεσσαλονίκη',
    points: 12240,
    ebe: '12.60',
  ...
  {
    id: '1064',
    name: 'Περιφερειακής και Οικ. Ανάπτυξης',
    uni: 'ΓΕΩΠΟΝΙΚΟ',
    city: 'Άμφισσα',
    points: 7040,
    ebe: '8.40',
  ...
  {
    id: '155',
    name: 'Χρηματοοικονομικής & Τραπεζικής',
    uni: 'ΠΑΠΕΙ',
    city: 'Πειραιάς',
    points: 14850,
    ebe: '12.60',
  ...
  {
    id: '1606',
    name: 'Λογιστικής και Πληροφοριακών Συστ.',
    uni: 'ΔΙΠΑΕ',
    city: 'Θεσσαλονίκη',
    points: 12360,
    ebe: '10.50',
  ...
  {
    id: '1435',
    name: 'Πολιτισμού & Δημιουργικών Μέσων',
    uni: 'ΘΕΣΣΑΛΙΑΣ',
    city: 'Βόλος',
    points: 9410,
    ebe: '8.40',
  ...
  {
    id: '1286',
    name: 'Επιστημών Εκπαίδευσης & Κοιν. Εργασίας',
    uni: 'ΠΑΤΡΩΝ',
    city: 'Πάτρα',
    points: 14422,
    ebe: '12.60',
  ...
  {
    id: '134',
    name: 'Επιστημών Προσχολικής Αγωγής',
    uni: 'ΑΠΘ',
    city: 'Θεσσαλονίκη',
    points: 13875,
    ebe: '8.40',
  ...
  {
    id: '136',
    name: 'Επιστημών Εκπαίδευσης & Προσχολ. Αγωγής',
    uni: 'ΠΑΤΡΩΝ',
    city: 'Πάτρα',
    points: 13000,
    ebe: '9.45',
  ...
  {
    id: '160',
    name: 'Επιστημών της Εκπαίδευσης στην Προσχολ.',
    uni: 'ΔΠΘ',
    city: 'Αλεξ/πολη',
    points: 10750,
    ebe: '8.40',
  ...
  {
    id: '1609',
    name: 'Βιβλιοθηκονομίας & Συστημάτων Πληρ.',
    uni: 'ΔΙΠΑΕ',
    city: 'Θεσσαλονίκη',
    points: 9300,
    ebe: '8.40',
  ...
  {
    id: '677',
    name: 'Φωτογραφίας & Οπτικοακουστικών',
    uni: 'ΠΑΔΑ',
    city: 'Αιγάλεω',
    points: 11540,
    ebe: '10.50',
  ...
  {
    id: '1424',
    name: 'Δασολογίας και Σχεδιασμού',
    uni: 'ΘΕΣΣΑΛΙΑΣ',
    city: 'Καρδίτσα',
    points: 8605,
    ebe: '8.40',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 h-28 flex flex-col justify-center">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <h1 className="text-xl font-black text-gray-900 dark:text-white shrink-0">
              ΒΑΣΕΙΣ <span className="text-pink-600">2025</span>
            </h1>
            ...
            <div className="flex w-full max-w-3xl gap-3">
              ...
              <div className="relative shrink-0">
                <Select value={activeCity} onValueChange={setActiveCity}>
                  ...
                  <SelectContent className="bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700 rounded-xl max-h-[240px]">
                    {cities.map((c) => (
                      <SelectItem
                        key={c}
                        value={c}
