...
const ALL_SCHOOLS: School[] = [
  ...
  { id: "818", name: "ΑΕΝ Σχολή Μηχανικών", uni: "ΑΕΝ", city: "Διάφορες", points: 8400, ebe: "8.40", category: "Ναυτιλιακά & Τουρισμός" },
  { id: "817", name: "ΑΕΝ Σχολή Πλοιάρχων", uni: "ΑΕΝ", city: "Διάφορες", points: 8400, ebe: "8.40", category: "Ναυτιλιακά & Τουρισμός" },

  // ΔΙΟΙΚΗΣΗ ΕΠΙΧΕΙΡΗΣΕΩΝ & MARKETING
  { id: "240", name: "Διοικητικής Επιστήμης και Τεχνολογίας", uni: "ΟΠΑ", city: "Αθήνα", points: 18400, ebe: "12.60", category: "Διοίκηση Επιχειρήσεων" },
  ...
  { id: "1282", name: "Διοικητικής Επιστήμης και Τεχνολογίας", uni: "ΠΑΤΡΩΝ", city: "Πάτρα", points: 12150, ebe: "11.55", category: "Διοίκηση Επιχειρήσεων" },
  { id: "352", name: "Διοίκησης Επιχειρήσεων", uni: "ΠΑΤΡΩΝ", city: "Πάτρα", points: 11900, ebe: "11.55", category: "Διοίκηση Επιχειρήσεων" },
  { id: "1518", name: "Διοικητικής Επιστήμης και Τεχνολογίας", uni: "ΠΕΛΟΠΟΝΝΗΣΟΥ", city: "Τρίπολη", points: 10075, ebe: "9.45", category: "Διοίκηση Επιχειρήσεων" },
  { id: "1655", name: "Διοίκησης Επιχειρήσεων και Τουρισμού", uni: "ΕΛΜΕΠΑ", city: "Ηράκλειο", points: 10088, ebe: "10.50", category: "Διοίκηση Επιχειρήσεων" },
  ...
  { id: "1607", name: "Διοικητικής Επιστήμης και Τεχνολογίας", uni: "ΔΠΘ", city: "Καβάλα", points: 9530, ebe: "8.40", category: "Διοίκηση Επιχειρήσεων" },
  { id: "1063", name: "Διοίκησης Γεωργικών Επιχειρήσεων", uni: "ΓΕΩΠΟΝΙΚΟ", city: "Θήβα", points: 9095, ebe: "9.45", category: "Διοίκηση Επιχειρήσεων" },
  ...
  { id: "400", name: "Οργάνωσης και Διαχείρισης Αθλητισμού", uni: "ΠΕΛΟΠΟΝΝΗΣΟΥ", city: "Σπάρτη", points: 8940, ebe: "8.40", category: "Διοίκηση Επιχειρήσεων" },
  { id: "1544", name: "Διοικητικής Επιστήμης και Τεχνολογίας", uni: "ΔΥΤ. ΜΑΚΕΔΟΝΙΑΣ", city: "Κοζάνη", points: 8920, ebe: "8.40", category: "Διοικητική Επιστήμη" },
  { id: "1656", name: "Διοικητικής Επιστήμης και Τεχνολογίας", uni: "ΕΛΜΕΠΑ", city: "Αγ. Νικόλαος", points: 8875, ebe: "8.40", category: "Διοικητική Επιστήμη" },
  ...
  { id: "1211", name: "Εφαρμοσμένης Πληροφορικής (Επιστ. Τεχν.)", uni: "ΠΑΜΑΚ", city: "Θεσσαλονίκη", points: 16915, ebe: "12.60", category: "Πληροφορική" },
  { id: "1212", name: "Εφαρμοσμένης Πληροφορικής (Πληρ. Συστ.)", uni: "ΠΑΜΑΚ", city: "Θεσσαλονίκη", points: 16705, ebe: "12.60", category: "Πληροφορική" },
  ...
  { id: "1625", name: "Μηχανικών Πληροφορικής & Ηλεκτρον. Συστ.", uni: "ΔΙΠΑΕ", city: "Θεσσαλονίκη", points: 14740, ebe: "12.60", category: "Πληροφορική" },
  { id: "1622", name: "Μηχανικών Πληρ. Υπολ. & Τηλεπικ.", uni: "ΔΙΠΑΕ", city: "Σέρρες", points: 13450, ebe: "10.50", category: "Πληροφορική" },
  { id: "1630", name: "Πληροφορικής", uni: "ΔΠΘ", city: "Καβάλα", points: 12880, ebe: "11.55", category: "Πληροφορική" },
  { id: "1624", name: "Μηχανικών Παραγωγής και Διοίκησης", uni: "ΔΙΠΑΕ", city: "Θεσσαλονίκη", points: 12585, ebe: "10.50", category: "Πληροφορική" },
  ...
  { id: "230", name: "Μηχανικών Παραγωγής και Διοίκησης", uni: "Πολυτεχνείο Κρήτης", city: "Χανιά", points: 12290, ebe: "12.60", category: "Πληροφορική" },
  { id: "389", name: "Μηχανικών Βιομηχανικής Σχεδίασης", uni: "ΠΑΔΑ", city: "Αιγάλεω", points: 12032, ebe: "12.39", category: "Πληροφορική" },
  { id: "224", name: "Μηχανικών Παραγωγής και Διοίκησης", uni: "ΔΠΘ", city: "Ξάνθη", points: 11590, ebe: "11.55", category: "Πληροφορική" },
  ...
  { id: "238", name: "Μηχανικών Σχεδίασης Προϊόντων", uni: "ΑΙΓΑΙΟΥ", city: "Σύρος", points: 10330, ebe: "10.50", category: "Πληροφορική" },
  { id: "1662", name: "Ηλεκτρονικών Μηχανικών", uni: "ΕΛΜΕΠΑ", city: "Χανιά", points: 10071, ebe: "8.40", category: "Πληροφορική" },
  { id: "1008", name: "Τεχνολογιών Ψηφιακής Βιομηχανίας", uni: "ΕΚΠΑ", city: "Ψαχνά", points: 9830, ebe: "8.92", category: "Πληροφορική" },
  { id: "344", name: "Μηχανικών Πληρ/κών & Επικ. Συστημάτων", uni: "ΑΙΓΑΙΟΥ", city: "Σάμος", points: 9660, ebe: "8.40", category: "Πληροφορική" },
  { id: "1542", name: "Μηχανικών Σχεδίασης Προϊόντων", uni: "ΔΥΤ. ΜΑΚΕΔΟΝΙΑΣ", city: "Κοζάνη", points: 9225, ebe: "8.92", category: "Πληροφορική" },
  ...
  { id: "1456", name: "Ψηφιακών Μέσων και Επικοινωνίας", uni: "ΙΟΝΙΟ", city: "Αργοστόλι", points: 8550, ebe: "8.40", category: "Πληροφορική" },
  ...
  { id: "176", name: "Βαλκανικών, Σλαβικών & Ανατ. Σπουδών", uni: "ΠΑΜΑΚ", city: "Θεσσαλονίκη", points: 12240, ebe: "12.60", category: "Ανθρωπιστικά & Κοινωνικά" },
  ...
  { id: "353", name: "Αγροτικής Ανάπτυξης", uni: "ΔΠΘ", city: "Ορεστιάδα", points: 9125, ebe: "8.40", category: "Οικονομικά" },
  { id: "222", name: "Μηχανικών Οικονομίας και Διοίκησης", uni: "ΑΙΓΑΙΟΥ", city: "Χίος", points: 9050, ebe: "8.40", category: "Διοίκηση Επιχειρήσεων" },
  { id: "1064", name: "Περιφερειακής και Οικ. Ανάπτυξης", uni: "ΓΕΩΠΟΝΙΚΟ", city: "Άμφισσα", points: 7040, ebe: "8.40", category: "Οικονομικά" },
  ...
  { id: "155", name: "Χρηματοοικονομικής & Τραπεζικής", uni: "ΠΑΠΕΙ", city: "Πειραιάς", points: 14850, ebe: "12.60", category: "Λογιστική & Χρηματοοικονομικά" },
  ...
  { id: "1606", name: "Λογιστικής και Πληροφοριακών Συστ.", uni: "ΔΙΠΑΕ", city: "Θεσσαλονίκη", points: 12360, ebe: "10.50", category: "Λογιστική & Χρηματοοικονομικά" },
  ...
  { id: "869", name: "Αξιωματικών Ελληνικής Αστυνομίας", uni: "ΑΣΤΥΝΟΜΙΑ", city: "Αθήνα", points: 17590, ebe: "8.40", category: "Σώματα Ασφαλείας & Στρατιωτικές" },
  { id: "887", name: "Ικάρων (ΣΙ) Εφοδιαστών", uni: "ΑΕΡΟΠΟΡΙΑ", city: "Αθήνα", points: 17465, ebe: "12.60", category: "Σώματα Ασφαλείας & Στρατιωτικές" },
  { id: "877", name: "Αξιωματικών Πυροσβεστικής", uni: "ΠΥΡΟΣΒΕΣΤΙΚΗ", city: "Αθήνα", points: 17460, ebe: "8.40", category: "Σώματα Ασφαλείας & Στρατιωτικές" },
  { id: "872", name: "Αξιωματικών ΕΛ.ΑΣ. (για Αστυνομικούς)", uni: "ΑΣΤΥΝΟΜΙΑ", city: "Αθήνα", points: 17370, ebe: "8.40", category: "Σώματα Ασφαλείας & Στρατιωτικές" },
  { id: "886", name: "Ικάρων (ΣΙ) Διοικητικών", uni: "ΑΕΡΟΠΟΡΙΑ", city: "Αθήνα", points: 17260, ebe: "12.60", category: "Σώματα Ασφαλείας & Στρατιωτικές" },
  { id: "881", name: "Σχολή Δοκίμων Σημαιοφόρων Λ.Σ.", uni: "ΛΙΜΕΝΙΚΟ", city: "Πειραιάς", points: 16650, ebe: "9.45", category: "Σώματα Ασφαλείας & Στρατιωτικές" },
  { id: "880", name: "ΣΜΥΑ - Κατ. Διοικ. & Εφοδ. Υποστήριξης", uni: "ΑΕΡΟΠΟΡΙΑ", city: "Αθήνα", points: 16030, ebe: "10.50", category: "Σώματα Ασφαλείας & Στρατιωτικές" },
  { id: "876", name: "Πυροσβεστών (για Πολίτες)", uni: "ΠΥΡΟΣΒΕΣΤΙΚΗ", city: "Αθήνα", points: 14460, ebe: "8.40", category: "Σώματα Ασφαλείας & Στρατιωτικές" },
  { id: "882", name: "Σχολή Δοκίμων Λιμενοφυλάκων", uni: "ΛΙΜΕΝΙΚΟ", city: "Πειραιάς", points: 13970, ebe: "9.45", category: "Σώματα Ασφαλείας & Στρατιωτικές" },
  { id: "863", name: "ΣΜΥ - Σώματα", uni: "ΣΤΡΑΤΟΣ", city: "Τρίκαλα", points: 13080, ebe: "8.40", category: "Σώματα Ασφαλείας & Στρατιωτικές" },
  { id: "870", name: "Αστυφυλάκων (για Πολίτες)", uni: "ΑΣΤΥΝΟΜΙΑ", city: "Αθήνα", points: 11710, ebe: "8.40", category: "Σώματα Ασφαλείας & Στρατιωτικές" },
  { id: "871", name: "Αξιωματικών Πυροσβεστικής (Πυροσβέστες)", uni: "ΠΥΡΟΣΒΕΣΤΙΚΗ", city: "Αθήνα", points: 9940, ebe: "8.40", category: "Σώματα Ασφαλείας & Στρατιωτικές" },
  { id: "864", name: "ΣΜΥΝ (Μονίμων Υπαξιωματικών Ναυτικού)", uni: "ΝΑΥΤΙΚΟ", city: "Πειραιάς", points: 8940, ebe: "9.45", category: "Σώματα Ασφαλείας & Στρατιωτικές" },
  ...
  { id: "1435", name: "Πολιτισμού & Δημιουργικών Μέσων", uni: "ΘΕΣΣΑΛΙΑΣ", city: "Βόλος", points: 9410, ebe: "8.40", category: "Μουσική & Πολιτισμός" },
  ...
  { id: "1286", name: "Επιστημών Εκπαίδευσης & Κοιν. Εργασίας", uni: "ΠΑΤΡΩΝ", city: "Πάτρα", points: 14422, ebe: "12.60", category: "Παιδαγωγικά" },
  { id: "134", name: "Επιστημών Προσχολικής Αγωγής", uni: "ΑΠΘ", city: "Θεσσαλονίκη", points: 13875, ebe: "8.40", category: "Παιδαγωγικά" },
  ...
  { id: "136", name: "Επιστημών Εκπαίδευσης & Προσχολ. Αγωγής", uni: "ΠΑΤΡΩΝ", city: "Πάτρα", points: 13000, ebe: "9.45", category: "Παιδαγωγικά" },
  ...
  { id: "160", name: "Επιστημών της Εκπαίδευσης στην Προσχολ.", uni: "ΔΠΘ", city: "Αλεξ/πολη", points: 10750, ebe: "8.40", category: "Παιδαγωγικά" },
  { id: "162", name: "Επιστημών Προσχολικής Αγωγής", uni: "ΑΙΓΑΙΟΥ", city: "Ρόδος", points: 10150, ebe: "8.40", category: "Παιδαγωγικά" },
  { id: "1609", name: "Βιβλιοθηκονομίας & Συστημάτων Πληρ.", uni: "ΔΙΠΑΕ", city: "Θεσσαλονίκη", points: 9300, ebe: "8.40", category: "Παιδαγωγικά" },
  ...
  { id: "181", name: "Μεσογειακών Σπουδών", uni: "ΑΙΓΑΙΟΥ", city: "Ρόδος", points: 8798, ebe: "8.40", category: "Ανθρωπιστικά & Κοινωνικά" },
  ...
  { id: "675", name: "Εσωτερικής Αρχιτεκτονικής", uni: "ΠΑΔΑ", city: "Αιγάλεω", points: 14405, ebe: "13.06", category: "Μουσική & Πολιτισμός", requirements: "Σχέδιο" },
  { id: "674", name: "Γραφιστικής και Οπτικής Επικοινωνίας", uni: "ΠΑΔΑ", city: "Αιγάλεω", points: 13745, ebe: "9.09", category: "Μουσική & Πολιτισμός", requirements: "Σχέδιο" },
  { id: "1626", name: "Εσωτερικής Αρχιτεκτονικής", uni: "ΔΙΠΑΕ", city: "Σέρρες", points: 13545, ebe: "9.09", category: "Μουσική & Πολιτισμός", requirements: "Σχέδιο" },
  { id: "677", name: "Φωτογραφίας & Οπτικοακουστικών", uni: "ΠΑΔΑ", city: "Αιγάλεω", points: 11540, ebe: "10.50", category: "Μουσική & Πολιτισμός" },
  ...
  { id: "212", name: "Δασολογίας & Περιβάλλοντος", uni: "ΔΠΘ", city: "Ορεστιάδα", points: 8640, ebe: "8.40", category: "Άλλα (Γεωγραφία, Περιβάλλον κ.α.)" },
  { id: "1424", name: "Δασολογίας και Σχεδιασμού", uni: "ΘΕΣΣΑΛΙΑΣ", city: "Καρδίτσα", points: 8605, ebe: "8.40", category: "Άλλα (Γεωγραφία, Περιβάλλον κ.α.)" },
      ...
      <nav className="sticky top-0 z-50 bg-white/90 dark:bg-gray-900/90 backdrop-blur-xl border-b border-gray-200 dark:border-gray-800 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 h-28 flex flex-col justify-center">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <h1 className="text-xl font-black text-gray-900 dark:text-white shrink-0">ΒΑΣΕΙΣ <span className="text-pink-600">2025</span></h1>
