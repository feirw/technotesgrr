            ...
            <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-pink-50 via-white to-rose-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 p-4">
                ...
                >
                    ...
                    <p className="text-gray-600 dark:text-gray-300 mb-8 leading-relaxed">
                        Στείλαμε ένα email επιβεβαίωσης στο <strong>{formData.email}</strong>. 
                        Παρακαλώ ελέγξτε τα εισερχόμενά σας (και τα spam) και κάντε κλικ στο σύνδεσμο για να ενεργοποιήσετε το λογαριασμό σας.
                    </p>
                    <Link 
                        to="/login"
            ...
            >
                <header className="text-center mb-8">
                    ...
                    <p className="text-gray-500 dark:text-gray-400">
                        Ξεκίνα το ταξίδι σου στο 100άρι! 🚀
                    </p>
                </header>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="space-y-1">
                        <label className="text-sm font-bold text-gray-700 dark:text-gray-300 ml-1">Username (Όνομα Χρήστη)</label>
                    ...
                    <div className="space-y-1">
                        <label className="text-sm font-bold text-gray-700 dark:text-gray-300 ml-1">Επιβεβαίωση Κωδικού</label>
                        <div className="relative">
                            <Lock className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-400" />
                            <input
                                type="password"
