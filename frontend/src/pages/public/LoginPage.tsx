      ...
      >
        <div className="flex flex-col items-center text-center mb-6">
          <PageMenuIcon
            ...
            className="w-9 h-9"
          />
          <h1 className="text-2xl font-black text-gray-900 dark:text-white">Σύνδεση</h1>
          <p className="mt-1.5 text-sm text-gray-500 dark:text-gray-400">
            Καλώς ήρθες πίσω στο TechNotesGR
          </p>
        </div>

        <form onSubmit={handleSubmit} noValidate className="space-y-4">
          <div>
            <label htmlFor="login-email" className="block text-sm font-semibold text-gray-700 dark:text-gray-200 mb-1.5">
              Email
            </label>
          ...
          <div>
            <label htmlFor="login-password" className="block text-sm font-semibold text-gray-700 dark:text-gray-200 mb-1.5">
              Κωδικός
            </label>
            <div className="relative">
          ...
          <div className="flex items-center justify-between text-sm">
            <label className="flex items-center gap-2 cursor-pointer select-none text-gray-600 dark:text-gray-300">
              <input
                ...
                className="w-4 h-4 rounded border-[#f07f97]/40 text-[#f07f97] focus:ring-[#f07f97]/40"
              />
              Να με θυμάσαι
            </label>
            <Link to="/forgot-password" className="font-semibold text-[#f07f97] hover:underline">
              Ξέχασες τον κωδικό;
            </Link>
          </div>
        ...
        <p className="mt-6 text-center text-sm text-gray-500 dark:text-gray-400">
          ...
          <Link to="/register" className="font-bold text-[#f07f97] hover:underline">
            Δημιούργησε έναν
          </Link>
        </p>
      </motion.div>
